...
class Scheduler(object):
    ...
    def __init__(self, task_type):
        ...
        self.log = UtilLogger('scheduler', os.path.join(os.path.dirname(os.path.abspath(__file__)), 'logs/scheduler_pulldown'))
...
def main():
    scheduler = Scheduler(config.TASK_TYPE_PULLDOWN)
    scheduler.run(1, 0, 0, 30, 1, 0, 1)
