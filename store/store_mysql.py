...
class StoreMysql(object):
    ...
    def query(self, sql):
        ...
        try:
            ...
            print("query Error connecting to MySQL on %s,%s,sql:%s" % (self.host, str(e), str(sql)[0: 100]))
            self.close()
        except Exception, e:
    ...
    def do(self, sql, flag='lastrowid'):
        ...
        try:
            ...
            print datetime.today()
            print("do Error connecting to MySQL on %s,%s,sql:%s" % (self.host, str(e), str(sql)[0:200]))
            self.close()
            return -1
        except Exception, e:
            print e
    ...
    def save(self, table, data, mapping_fields=dict()):
        ...
        try:
            ...
            print "insert into save myself database exception"
            return -1
